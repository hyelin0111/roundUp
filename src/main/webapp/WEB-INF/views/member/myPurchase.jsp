...
<style>
div.purchase-complete-container {
	height: 550px;
}
	...
	if (confirm("주문을 취소하시겠습니까?")) {
		jQuery.ajax({
			...
			success : function(data) {
				console.log(data);
				if (data === "success") alert("주문 취소에 성공하였습니다.");
				else alert("주문 취소에 실패하였습니다.");
...
function searchPurchaseList() {
	...
	location.href = "${pageContext.request.contextPath}/member/myPagePurchaseComplete.do?"
			+ "member_id=${member_id}" + "&searchKeyword="+ searchKeyword
